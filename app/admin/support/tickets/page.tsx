    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#090909_0%,#111111_35%,#0b0b0b_100%)] text-white">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-[30px] border border-white/10 bg-white/[0.04] p-6">
          <p className="text-[10px] uppercase tracking-[0.42em] text-amber-200/80">Support review</p>
          <h1 className="mt-2 text-3xl font-semibold">Admin support tickets</h1>
        </div>

        <div className="mt-6 space-y-3">
          {supportTickets.map((ticket) => (
            <Link key={ticket.id} href={`/admin/support/tickets/${ticket.ticketNumber}`} className="block rounded-[28px] border border-white/10 bg-black/30 p-4">
