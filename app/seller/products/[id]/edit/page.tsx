  ...
  useEffect(() => {
    void (async () => {
      ...
      setForm({
        ...
        imagePrimaryIndex: Number(product.image_primary_index ?? 0),
        tagsCsv: Array.isArray(product.tags) ? product.tags.join(", ") : "",
        yearEra: String(product.year_era ?? ""),
        availability: String(product.availability ?? "in_stock") as SellerProductForm["availability"],
