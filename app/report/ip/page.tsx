      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold text-white">Report intellectual property or unauthorized brand use</h1>
          </div>
        ...
        <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6">
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm leading-6 text-zinc-300">
            Reports are reviewed by the admin compliance queue. Submissions are for review and operational moderation only and do not constitute a final legal determination.
          </div>
        </div>
      </div>
    </main>
