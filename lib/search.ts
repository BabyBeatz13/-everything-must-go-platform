...
const categoryRegistry = {
  ...
  shoes: {
    name: "Shoes",
    slug: "shoes",
    aliases: ["shoes", "footwear", "boots", "sneakers", "dress shoes", "sandals"],
    parent: "fashion",
    subcategories: ["Sneakers", "Boots", "Dress Shoes", "Sandals"],
  },
  beauty: {
    name: "Beauty",
    slug: "beauty",
  ...
  "studio-music": {
    name: "Studio & Music",
    slug: "studio-music",
    aliases: ["studio and music", "studio & music", "studio", "music", "recording", "audio production"],
    parent: null,
    subcategories: ["Studio Equipment", "Music Software", "Recording Gear"],
  },
  "pet-supplies": {
  ...
  vintage: {
    name: "Vintage",
    slug: "vintage",
    aliases: ["vintage", "retro", "classic", "old stock", "era"],
    parent: null,
    subcategories: ["Vintage Fashion", "Vintage Jewelry", "Vintage Gaming", "Vintage Fragrance"],
  },
  automotive: {
    name: "Automotive",
    slug: "automotive",
    aliases: ["automotive", "car parts", "auto parts", "car care", "vehicle accessories"],
    parent: null,
    subcategories: ["Parts", "Accessories", "Car Care"],
  },
  tools: {
    name: "Tools",
    slug: "tools",
    aliases: ["tools", "power tools", "hand tools", "workshop"],
    parent: null,
    subcategories: ["Power Tools", "Hand Tools", "Workshop"],
  },
  sports: {
    name: "Sports",
    slug: "sports",
    aliases: ["sports", "sports equipment", "athletics", "team sports"],
    parent: null,
    subcategories: ["Equipment", "Athletics", "Team Sports"],
  },
  toys: {
    name: "Toys",
    slug: "toys",
    aliases: ["toys", "kids toys", "playsets", "games"],
    parent: null,
    subcategories: ["Action Figures", "Board Games", "Playsets"],
  },
  "books-media": {
    name: "Books & Media",
    slug: "books-media",
    aliases: ["books and media", "books & media", "books", "media", "vinyl", "movies"],
    parent: null,
    subcategories: ["Books", "Vinyl", "Movies", "Magazines"],
  },
  garden: {
    name: "Garden",
    slug: "garden",
