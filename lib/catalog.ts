...
export function catalogRecordToSearchable(record: CatalogRecord): SearchableProduct {
  return buildSearchDocument({
    ...
    purchase_url: record.affiliate_url ?? record.product_url ?? null,
    price: record.price,
    ...
    year_label: record.release_year ? String(record.release_year) : null,
    ...
    metal: record.jewelry?.metal ?? null,
    karat: record.jewelry?.karat ?? null,
    weight: record.jewelry?.weight ?? null,
    chain_length: record.jewelry?.chain_length ?? null,
    chain_width: record.jewelry?.chain_width ?? null,
    stone: record.jewelry?.stone ?? null,
    diamond_type: record.jewelry?.diamond_type ?? null,
    carat_weight: record.jewelry?.carat_weight ?? null,
    certification: record.jewelry?.certification ?? null,
  });
}
